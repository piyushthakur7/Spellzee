        ...
        <div className="trust-card-wrapper">
          ...
          <div className="trust-grid">
            ...
            <div className="trust-item">
              ...
              <h4 className="trust-item-heading sm">Incubated Company</h4>
            ...
            <div className="trust-item">
              ...
              <h4 className="trust-item-heading sm no-wrap">Certified Teachers Methods</h4>
            ...
            <div className="trust-item">
              <div className="trust-item-logo stat-row">
                <div className="trust-item-label large-label no-margin">10,000+</div>
              </div>
              <h4 className="trust-item-heading lg">Happy Parents</h4>
            ...
            <div className="trust-item">
              <div className="trust-item-logo stat-row">
                <div className="trust-item-label large-label no-margin">4.9 <span className="star-inline">★</span></div>
              </div>
              <h4 className="trust-item-heading lg">Parent Rating</h4>
